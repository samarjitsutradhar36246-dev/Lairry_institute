  ...
  useEffect(() => {
    const loadProfile = async () => {
      ...
      try {
        ...
        setInstituteName(profile_data?.institute_name);
      } catch (err) {
  ...
  return (
    <Box
      ...
      <Box
        ...
        <SidebarGlobal isOpen={sidebarOpen} setIsOpen={setSidebarOpen} />
      ...
      <Box
        ...
        <Footer profileImage={profileImage} instituteName={instituteName} />
      </Box>
    </Box>
  );
};
